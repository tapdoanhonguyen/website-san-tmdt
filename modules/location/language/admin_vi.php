...
$lang_module['vnpostid'] = 'VNPOST';
$lang_module['vtpid'] = 'VIETTEL';
$lang_module['ghnid'] = 'GHN';
...
//Lang for function area
$lang_module['area'] = 'area';
$lang_module['title_area'] = 'Tên khu vực';
$lang_module['error_required_title_area'] = 'Lỗi: bạn cần nhập dữ liệu cho Tên khu vực';

//Lang for function area_district
$lang_module['area_district'] = 'area_district';
$lang_module['id_area'] = 'Khu vực';
$lang_module['error_required_id_area'] = 'Lỗi: bạn cần nhập dữ liệu cho Khu vực';

//Lang for function area_province
$lang_module['area_province'] = 'Khu vực';
$lang_module['refresh_redis'] = 'Xóa cache';
