...
if ($nv_Request->isset_request('submit', 'post')) {
	...
	} elseif (empty($row['weight_product'])) {
		$error[] = $lang_module['error_required_weight_product'];
	} elseif (empty($row['length_product'])) {
		$error[] = $lang_module['error_required_length_product'];
	} elseif (empty($row['width_product'])) {
		$error[] = $lang_module['error_required_width_product'];
	} elseif (empty($row['height_product'])) {
		$error[] = $lang_module['error_required_height_product'];
