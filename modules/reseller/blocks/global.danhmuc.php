...
if (!nv_function_exists('nvb_home_danhmuc')) {
    ...
    {
        global $nv_Cache, $global_config, $site_mods, $module_info, $module_name, $module_file, $module_data, $lang_global, $catid, $home, $db;
        ...
        $sql = 'SELECT * FROM ' .$db_config['dbsystem']. '.'. NV_PREFIXLANG . '_' . $block_config['module'] . '_categories WHERE status=1 AND parrent_id = 0 limit ' . $block_config['number_item'];
