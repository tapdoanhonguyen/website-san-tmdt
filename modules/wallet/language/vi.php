...
$lang_module['acount_bank'] = 'Tài khoản ngân hàng';
$lang_module['userid_receiver'] = 'Tài khoản người nhận';
$lang_module['money_fees'] = 'Phí dịch vụ';
$lang_module['withdrawal'] = 'Yêu cầu rút tiền từ ví về tài khoản ngân hàng';
$lang_module['transfers'] = 'Yêu cầu chuyển khoản từ ví tiền sang ví tiền khác';
$lang_module['totalwithdrawal'] = 'Tổng số tiền được rút';
$lang_module['totaltransfer'] = 'Tổng số tiền được chuyển';
$lang_module['vnd'] = 'VNĐ';
...
$lang_module['error_money_withdrawal'] = 'Số tiền rút phải lớn hơn 0';
$lang_module['error_money_withdrawal1'] = 'Số tiền rút vào phải lớn hơn hoặc bằng %s';
$lang_module['error_money_withdrawal2'] = 'Ví tiền không đủ hoặc bạn chỉ rút được tối thiểu số tiền %s';
$lang_module['payclass_error_acount_bank'] = 'Vui lòng chọn số tài khoản nhận tiền';
...
$lang_module['money_withdrawal_minmax'] = 'Bạn có thể rút tối thiểu %1$s và tối đa là %2$s';
...
$lang_module['transaction_status6'] = 'Rút tiền thành công';
$lang_module['transaction_status7'] = 'Chuyển tiền thành công';
...
//Lang for function withdrawal
$lang_module['add'] = 'Thêm mới';
$lang_module['edit'] = 'Sửa';
$lang_module['delete'] = 'Xóa';
$lang_module['number'] = 'STT';
$lang_module['active'] = 'Trạng thái';
$lang_module['acount_cccd'] = 'Acount cccd';
$lang_module['save'] = 'Lưu thay đổi';
$lang_module['user_edit'] = 'Người sửa';
$lang_module['time_add'] = 'Thời gian thêm';
$lang_module['time_edit'] = 'Thời gian sửa';
$lang_module['bank_acount'] = 'Tài khoản ngân hàng';
$lang_module['acount_userid'] = 'Tài khoản thành viên';
$lang_module['acount_phone'] = 'Số điện thoại';
$lang_module['acount_regdate'] = 'Ngày tham gia';
$lang_module['acount_name'] = 'Họ và tên';
$lang_module['acount_cccd'] = 'CMND / CCCD';
$lang_module['acount_date_range'] = 'Ngày cấp';
$lang_module['acount_issued_by'] = 'Nơi cấp';
$lang_module['acount_number'] = 'Số tài khoản';
$lang_module['acount_bankid'] = 'Tên ngân hàng';
$lang_module['acount_bankbranch'] = 'Chi nhánh';
$lang_module['bank'] = 'Ngân hàng';
$lang_module['bank_code'] = 'Mã code ngân hàng';
$lang_module['name_bank'] = 'Tên ngân hàng';
$lang_module['user_add'] = 'Người thêm';
$lang_module['error_required_bank_code'] = 'Lỗi: bạn cần nhập dữ liệu cho Mã code ngân hàng';
$lang_module['error_required_name_bank'] = 'Lỗi: bạn cần nhập dữ liệu cho Tên ngân hàng';
$lang_module['withdrawal_fees'] = 'Phí rút tiền';
$lang_module['transfer_fees'] = 'Phí chuyển khoản';
$lang_module['minimum'] = 'Số dư tối thiểu';