...
if ($nv_Request->isset_request('submit', 'post')) {
    ...
    $array_config['minimum'] = $nv_Request->get_int('minimum', 'post', '');
    $array_config['withdrawal_fees'] = $nv_Request->get_int('withdrawal_fees', 'post', '');
    $array_config['transfer_fees'] = $nv_Request->get_int('transfer_fees', 'post', '');
