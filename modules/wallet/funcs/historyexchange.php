...
$db->sqlreset();
$db->from(MODULE_WALLET . "_transaction");
...
while ($row = $result->fetch()) {
	...
	if(empty($_SESSION['password_wallet'])){
		$_SESSION['password_wallet']='';
	}
$generate_page = nv_alias_page($page_title, $base_url, $all_page, $per_page, $page);
$contents = nv_wallet_history_exchange($array,$_SESSION['password_wallet'], $generate_page, $page, $per_page);
