...
abstract class Base
{
    /**#@+
     * @access public
     * @see \Phpseclib3\Crypt\Base::encrypt()
     * @see \Phpseclib3\Crypt\Base::decrypt()
     */
    /**
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \Phpseclib3\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
     ...
     *
     * - \Phpseclib3\Crypt\Base::ENGINE_OPENSSL  [very fast]
     *
     * - \Phpseclib3\Crypt\Base::ENGINE_MCRYPT   [fast]
     *
     * - \Phpseclib3\Crypt\Base::ENGINE_INTERNAL [slow]
     *
