...
<div class="bg_white p-3 rounded">
	...
	<div class="row m-0 rounded">
		<div class="col-2 py-3 font-weight-bold text-center tab1" style="cursor:pointer" status_id="1"  onclick="list(1)" >
			Shop
		</div>
		<div class="col-2 py-3 text-center font-weight-bold tab2" style="cursor:pointer" status_id="0" onclick="list(0)">
			Chợ Nhà Giàu
		</div>
	</div>
