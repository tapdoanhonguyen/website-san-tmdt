...
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/xzoom.css">
<link rel="stylesheet" href="{NV_BASE_SITEURL}themes/{TEMPLATE}/css/magnific-popup.css">

<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/xzoom.min.js"></script>
<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/magnific-popup.js"></script>
<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/foundation.min.js"></script>
<script src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/setup.js"></script>
...
<section class="productDetail bg_white rounded-sm mb-3">
	<div class="row ">
		<div class="col-5 px-4 pt-3">
			<div class="xzoom-container">
				<div class="img_primary beauty_img mb-3 d-flex">
					<!-- BEGIN: oneimage -->
						<img class="xzoom5 max_w_h" id="xzoom-magnific"  src="{IMAGE.file}" xoriginal="{IMAGE.file}" />
                    <!-- END: oneimage -->
		...
		<div class="col-7 my-3 pr-2">
			...
			<div class="productDetail_reviews">
				<a class="productDetail_reviews_item  ml-0"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icon/{ROW.star}star.svg" class="img-fluid height_16" alt=""></a>
			...
			<!-- BEGIN: free_ship -->
			<div class="">
				<img class="icon_freeshiptab pb-2" src="/themes/default/images/icon_freeship1.png" />
				<div>
					<!-- END: free_ship -->
				...
				<div class="item_order_number_detail {check_cart_tonkho}">
					...
					<div class="productDetail_clickBuy mt-3">
						<button onclick="add_cart()" class="btn_irv_outline_lg mr-3">Thêm vào giỏ hàng</button>
						<button onclick="add_cart_order()" class="btn_irv_lg ">Mua ngay</button>
					</div>
				</div>	
				...
				<div class="productDetail_share mt-4 ">
					<div class="productDetail_share_media d-inline ">
						...
						<a href="https://www.facebook.com/v9.0/dialog/send?app_id={FACEBOOKID}&display=popup&link={URL_SHARE}&redirect_uri={ROW.image}" class="px-1 share">
							<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
		...
		<div class="row">
			...
			<div class="col-md-5 m-3 d-flex">
				...
				<div class="productDetail_shop_info ml-3 mt-3">
					...
					<a title="{info_store.company_name}" class="btn_irv" href="{info_store.alias}">Xem Shop</a>
				</div>
			</div>
	...
	<section class="productDetail_desc mb-3">
		<div class="mb-3">
			...
			<ul class="nav nav-pills d-flex justify-content-between bg_white">
				<!-- BEGIN: tabs_title -->
				<li role="presentation" class="nav-item fs_18 text-center <!-- BEGIN: active -->active<!-- END: active -->" style="width: 32%"
					> <a href="#{TABS_KEY}-{TABS_ID}" class="py-3 d-block w-100 h-100" aria-controls="{TABS_KEY}-{TABS_ID}" role="tab" data-toggle="tab"> <!-- BEGIN: icon --> <img src="{TABS_ICON}" /> <!-- END: icon --> <!-- BEGIN: icon_default --> <em class="fa fa-bars">&nbsp;</em> <!-- END: icon_default --> <span>{TABS_TITLE}</span>
				</a>
				</li>
				<!-- END: tabs_title -->
			</ul>
	...
	<div class="productDetail_other mb-4">
		<div class="d-flex justify-content-between">
			<p class="fs_20">{LANG.more}</p>
			<!-- BEGIN: readmore -->
			<button class="btn_none secondary_text readmore_productorther_ajax">{LANG.more}</button>
	...
	<div class="productDetail_canLike mb-4">
		<div class="d-flex justify-content-between">
			<p class="fs_20">{LANG.wish}</p>
			<!-- BEGIN: readmore -->
			<button class="btn_none secondary_text readmore_productstore_ajax">{LANG.more}</button>
...
<div class="tab-content bg_white position-relative rounded-sm px-3 pb-5">
			<div id="description" class="tab-pane  active ">
				...
				<div class="w-100 pt-1 text-center position-absolute bg_white readmore_des">
					<button id="btn_readmore_des">{LANG.more}</button>
				</div>
			</div>
			...
			<div id="specifications" class="tab-pane fade">
				...
				<div class="w-100 text-center position-absolute bg_white readmore_spec">
					<button id="btn_readmore_spec">{LANG.more}</button>
				</div>
			</div>
				...
				<div class="rating_map  py-3">
					<div class="row bg_gray mx-5">
						<div class="col-md-4 my-4 text-center rating_left">
							...
							<img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icon/{ROW.star}star.svg" class="d-block my-2" alt="">
							<p class="text_gray_color mb-0">{total_rate} {LANG.review}</p>
						</div>
						<div class="col-md-8 pl-4 py-2 rating_right my-4">
							<div class="row mb-1 align-items-center">
								<div class="col-md-4 text-center"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icon/5star.svg" class="img-fluid" alt=""></div>
								<div class="col-md-6">
									<div class="progress">
							...
							<div class="row mb-1 align-items-center">
								<div class="col-md-4 text-center "><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icon/4star.svg" class="img-fluid" alt=""></div>
								<div class="col-md-6">
									<div class="progress">
							...
							<div class="row mb-1 align-items-center">
								<div class="col-md-4 text-center"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icon/3star.svg" class="img-fluid" alt=""></div>
								<div class="col-md-6">
									<div class="progress">
							...
							<div class="row mb-1 align-items-center">
								<div class="col-md-4 text-center"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icon/2star.svg" class="img-fluid" alt=""></div>
								<div class="col-md-6">
									<div class="progress">
							...
							<div class="row mb-1 align-items-center">
								<div class="col-md-4 text-center"><img src="{NV_BASE_SITEURL}themes/{TEMPLATE}/images/icon/1star.svg" class="img-fluid" alt=""></div>
								<div class="col-md-6">
									<div class="progress">
