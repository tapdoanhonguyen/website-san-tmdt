    ...
    <div style="width: 700px; padding: 16px; margin: 0 auto;">
        ...
        border-radius: 4px;padding: 24px 16px;">
            ...
            <div style="border-top:1px solid #DADADA;margin-top: 20px;">
                <p style="font-size:16px">Thông tin đơn hàng <span
                        style="font-weight: 700;color: #E1A208;">#{DATA.order_code}</span></p>
        ...
        border-top: 1px solid #dadada;">
            ...
            <div style="margin-bottom: 30px;margin-top: 15px;">
                <span style="color: #E03C00;">*</span>Vui lòng đăng nhập vào tài khoản của bạn trên website <a
                    href="https://banhang.chonhagiau.com/" style="color: #E1A208;">banhang.chonhagiau.com</a> và xác
                nhận đơn hàng.
            ...
            <div style="display: flex;width: 70%;">
                ...
                <div style="padding-left: 8px;">
                    ...
                    <div style="font-size:10px;line-height:20px;color:#444444">
                        Email:
                        <a href="mailto:{CONFIG.email_ecng}" style="color:#444444;text-decoration:none"
                            target="_blank">{CONFIG.email_ecng}</a>
                        <br>
                        Điện thoại:
                        <a href="tel:{CONFIG.phone_ecng}" style="color:#444444;text-decoration:none"
                            target="_blank">{CONFIG.phone_ecng}</a>
                    </div>
                </div>
            </div>
