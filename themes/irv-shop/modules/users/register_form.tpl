<form class="user-reg-form" action="{USER_REGISTER}" method="post" onsubmit="return reg_validForm(this);" autocomplete="off" novalidate>
    ...
    <div class="form-detail">
		...
		<div class="form-group">
            <div>
                <input type="tel" onkeyup="this.value=this.value.replace(/[^\d]/,'')" class="form-control required"  maxlength="10" placeholder="Số điện thoại" value="" name="phone" onkeypress="validErrorHidden(this);" data-mess="Vui lòng nhập số điện thoại" >
            </div>
        </div>
        <!-- BEGIN: show_birthday -->
        <div class="form-group">
