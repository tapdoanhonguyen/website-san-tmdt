...
<div class="dropdown mb-3" id="notification-area">
	<span id="notification" style="display: none"></span>
	<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <i class="fa fa-bell-o text_white fa-lg" aria-hidden="true"></i></a>
	<div class="dropdown-menu">
	<div>
		<div class="slimScrollDiv" style="position: relative; width: auto; height: 350px;">
			<div id="notification_load" style=" width: auto; max-height: : 350px;overflow-y: scroll;">
				<div class="notify_item clearfix">
				Vui lòng đăng nhập để xem thông báo!
				</div>
			</div>
			<div class="slimScrollBar" style="background: rgb(0, 0, 0); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 350px;">
			</div>
