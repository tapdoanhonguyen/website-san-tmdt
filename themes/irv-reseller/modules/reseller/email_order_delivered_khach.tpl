    ...
    <div style="width: 700px; padding: 16px; margin: 0 auto;">
        ...
        border-radius: 4px;padding: 24px 16px;">
            ...
            <div>
                ...
                style="font-weight: bold;color: #E1A208;text-decoration: none;">#{DATA.order_code}</a> của bạn <span style="font-weight: 700;">đã được giao thành công</span></span>
            </p>
            <p>Hãy chia sẻ cảm nhận của bạn và giúp khách hàng khác đưa ra quyết định mua sắm.</p>
        </div>
