			...
			<div class="form-group row mb-4 pt-2">
				...
				<div class="col-8">
					<div class="input-group">
						...
						<div class="d-flex border align-items-center pl-2 pr-3">
							<div class="input_error_noIcon">
	...
	<div class="bg_white p-3 col-7 rounded">
		<form id="add_voucher" >
			...
			<div class="form-group row mb-4 pt-2">
				<label class="col-4 col-form-label">Thời gian sử dụng</label>
				<div class="col-4">
					<input id="time_from" readOnly type="text" value="{TIME_FROM}" maxlength="10" name="time_from" class="form-control ">
				</div>
				<div class="col-4">
					<input id="time_to" readOnly type="text" value="{TIME_FROM}" maxlength="10" name="time_to"
					class="form-control ">
				</div>
			</div>
...
<script>
	...
	$.ajax({
	type : 'POST',
	url : nv_base_siteurl + 'index.php?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=voucher-add1&popup_list_product_add=1',
...
function add_voucher1(){
	...
	$.ajax({
		type: 'GET',
		url: nv_base_siteurl + 'index.php' + '?'  + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable +'=voucher-add1&mod=add_voucher1',
		dataType: "json",
		data: {
