    ...
    <div style="width: 700px; padding: 16px; margin: 0 auto;">
        ...
        border-radius: 4px;padding: 24px 16px;">
            ...
            <div>
                ...
                style="font-weight: bold;color: #E1A208;text-decoration: none;">#{DATA.order_code}</a> của bạn <span style="font-weight: 700;">giao không thành công</span></span>
            </p>
            <p>Vui lòng liên hệ lại số điện thoại <a href="tel:1900966961" style="text-decoration: none;">1900966961</a> để được hỗ trợ.</p>
        </div>
