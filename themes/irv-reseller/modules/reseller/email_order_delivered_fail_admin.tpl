    ...
    <div style="width: 700px; padding: 16px; margin: 0 auto;">
        ...
        border-radius: 4px;padding: 24px 16px;">
            ...
            <div>
                <p>Chào <span style="font-weight: 700;">Admin ECNG</span> </p>
                <p style="margin: 0;line-height: 28px;">Đơn hàng <a href="{VIEW_ORDER}"
                style="font-weight: bold;color: #E1A208;text-decoration: none;">#{DATA.order_code}</a> của seller - {SHOP_NAME} <span style="font-weight: 700;">giao không thành công</span></span>
            </p>
