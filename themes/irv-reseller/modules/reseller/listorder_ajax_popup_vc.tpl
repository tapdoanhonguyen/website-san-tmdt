...
<div class="p-4 text-center">
    ...
    <div class="row mt-4" style="border-top:2px solid #e8b841">
        <div class="col-6 pt-3" style="border-right:2px solid #e8b841">
    ...
    <div class="mt-4 text-center">
        ...
        <button onclick="{send_vanchuyen}({VIEW.id},'{OP}')" class="btn_ecng">Gửi</button>
    </div>
    <!-- END: khaigia_vnpost -->
    ...
    <div class="mt-4 text-center">
        <button class="btn_gray mr-3 text-dark border-0" style="width:180px;background: #DADADA;"
            data-dismiss="modal">Hủy</button>
        <button onclick="send_ghn({VIEW.id},'{OP}')" style="width:180px" class="btn_ecng">Gửi</button>
    </div>
    <!-- END: GHN -->
        ...
        <p class="mb-0">
            Hàng hóa có giá trị đóng bảo hiểm < 1.000.000VNĐ: Miễn phí bảo hiểm hàng hóa. GHTK sẽ bồi hoàn 100% giá trị
                ...
                <p class="mb-0 pt-2">Hàng hóa có giá trị đóng bảo hiểm >= 1.000.000 VNĐ (tối đa là 20.000.000 VNĐ): Phí
                    ...
                    trên hệ thống (tối đa 20.000.000đ).
                </p>
    ...
    <div class="mt-4 text-center">
        <button class="btn_gray mr-3 text-dark border-0" style="width:180px;background: #DADADA;"
            data-dismiss="modal">Hủy</button>
        <button onclick="send_ghtk({VIEW.id},'{OP}')" style="width:180px" class="btn_ecng">Gửi</button>
    </div>
    <!-- END: GHTK -->
</div>
