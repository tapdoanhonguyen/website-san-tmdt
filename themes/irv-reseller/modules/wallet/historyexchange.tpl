<!-- BEGIN: main -->
<!-- BEGIN: password_wallet -->
<div class="panel panel-default">
	<div class="panel-heading">Vui lòng nhập mật khẩu giao dịch</div>
	<p><input type="password" name="password_wallet" class="form-control"></input></p>
	<p class="text-center">
		<button class="btn btn-primary" onclick="password_wallet()">Xác nhận</button>
	</p>
</div>
<!-- END: password_wallet -->
