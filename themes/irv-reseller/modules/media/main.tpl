    ...
    <div class="clearfix" id="fileInfoLink">
        ...
        <div class="input-group input-group-sm">
            ...
            <span class="input-group-btn">
                <button title="Coppy đường dẫn" class="btn btn-default" data-clipboard-target="#FileAbsolutePath" id="FileAbsolutePathBtn" data-title="{LANG.filepathcopied}" data-placement="left" data-container="body" data-trigger="manual" data-animation="0"><i class="fa fa-copy"></i></button>
            </span>
        </div>
    </div>
</div>
...
var nv_module_url = "{NV_BASE_SITEURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&{NV_NAME_VARIABLE}={MODULE_NAME}&{NV_OP_VARIABLE}=";
