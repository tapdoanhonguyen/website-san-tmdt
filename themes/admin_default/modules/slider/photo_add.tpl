    ...
    <div class="panel panel-default">
		...
		<div class="panel-body">
			<form action="" method="post"  enctype="multipart/form-data" id="form-photo" class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label" for="input-status">{LANG.type_link}</label>
					<div class="col-sm-20">
						<select name="type_link" id="input-type_link" class="form-control">
							<option value="0">-- Chọn type link --</option>
							<!-- BEGIN: type_link -->
							<option value="{type_link.key}" {type_link.selected}>{type_link.name}</option>
							<!-- END: type_link -->
						</select>
					</div>
				</div>	
				...
				<div class="form-group">
					<label class="col-sm-4 control-label" for="input-links">{LANG.alias_type_link}</label>
					<div class="col-sm-20">
						<input type="text" name="alias_type_link" value="{DATA.alias_type_link}" placeholder="{LANG.alias_type_link}" id="input-alias_type_link" class="form-control" />
					</div>
				</div> 	
