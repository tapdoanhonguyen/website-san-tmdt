...
<form action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post" class="form-horizontal">
	...
	<div class="form-group">
        <label class="control-label col-sm-10 col-md-8 col-lg-5"><strong>{LANG.minimum}</strong></label>
        <div class="col-sm-14 col-md-16 col-lg-19">
             <input type="text" class="form-control" name="minimum" value="{DATA.minimum}">
        </div>
    </div>
	<div class="form-group">
        <label class="control-label col-sm-10 col-md-8 col-lg-5"><strong>{LANG.withdrawal_fees}</strong></label>
        <div class="col-sm-14 col-md-16 col-lg-19">
             <input type="text" class="form-control" name="withdrawal_fees" value="{DATA.withdrawal_fees}">
        </div>
    </div>
	<div class="form-group">
        <label class="control-label col-sm-10 col-md-8 col-lg-5"><strong>{LANG.transfer_fees}</strong></label>
        <div class="col-sm-14 col-md-16 col-lg-19">
             <input type="text" class="form-control" name="transfer_fees" value="{DATA.transfer_fees}">
        </div>
    </div>
    <div class="form-group">
