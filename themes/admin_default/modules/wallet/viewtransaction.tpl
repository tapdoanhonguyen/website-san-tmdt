    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody>
            ...
            <tr>
                ...
                <td><strong class="text-danger">{CONTENT.fee} {CONTENT.money_unit}</strong></td>
            </tr>
            <tr>
			...
			<!-- BEGIN: bank_acount -->
            <tr style="background: #fdff7c;">
                <td colspan="2">{LANG.bank_acount}</td>
            </tr>
			 <!-- BEGIN: loop -->
			<tr style="background: #fdff7c;">
                <td>{LANG.bank_acount}</td>
                <td>{bank_acount}</td>
            </tr>
			<!-- END: loop -->
			<!-- END: bank_acount -->
            ...
            <tr style="background: #dc0000;color:#fff">
                <td>{LANG.userid_receiver}</td>
				<td>{userid_receiver}</td>
            </tr>
