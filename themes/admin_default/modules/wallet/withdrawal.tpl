        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
					...
					<th>{LANG.bank}</th>
                    <th class="text-right">{LANG.moneytransaction}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{CONTENT.view_user}">{CONTENT.accounttran} <br/>{CONTENT.acount_name}</a></td>
					<td>{LANG.acount_cccd}: {CONTENT.acount_cccd} <br/>{LANG.acount_issued_by}: {CONTENT.acount_issued_by} <br/>{LANG.acount_date_range}: {CONTENT.acount_date_range}</td>
					<td>{LANG.acount_number}: {CONTENT.acount_number}<br/>
					{LANG.acount_bankid}: {CONTENT.acount_bankid}<br/>
					{LANG.acount_bankbranch}: {CONTENT.acount_bankbranch}</td>
					
                    <td class="text-right"><strong class="text-danger">{CONTENT.status}{CONTENT.money_total}&nbsp;{CONTENT.money_unit}</strong></td>
