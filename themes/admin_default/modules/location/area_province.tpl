...
<form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
    ...
    <div class="form-group">
        <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.id_area}</strong> <span class="red">(*)</span></label>
        <div class="col-sm-19 col-md-20">
            <select class="form-control" name="id_area">
                <option value=""> --- </option>
                <!-- BEGIN: select_id_area -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-19 col-md-20">
            <select multiple class="form-control districtid" name="districtid[]">
                <option value=""> --- </option>
                <!-- BEGIN: select_districtid -->
                <option value="{OPTION.key}" {OPTION.selected}>{OPTION.title}</option>
                <!-- END: select_districtid -->
            </select>
        </div>
    </div>
