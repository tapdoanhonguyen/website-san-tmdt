...
<div class="panel panel-default">
	<div class="panel-body">
		<form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
			...
			<!-- END: add_user -->
			<!-- BEGIN: edit -->
			<input type="text" class="form-control" name="userid" id="userid" value="{ROW.userid}" />
			<input type="button" value="Chọn" onclick="open_browse_us()" class="btn btn-default">
			<!-- END: edit -->
			<!-- BEGIN: noedit2 -->
			<div class="form-group">
				<label class="col-sm-5 col-md-4 control-label">
...
function open_browse_us() {
		nv_open_browse('{NV_BASE_ADMINURL}index.php?' + nv_name_variable + '=users&' + nv_fc_variable + '=getuserid&area=userid&return=userid&filtersql={FILTERSQL}', 'userid', 850, 500, 'resizable=no,scrollbars=no,toolbar=no,location=no,status=no');
	} 
$('html,body').animate({
	scrollTop: 0
}, 'fast');
