	...
	<body style="background:#DADADA">
		<div style="width: 600px; padding: 16px; margin: 0 auto;">
			...
			border-radius: 4px;padding: 24px 16px;">
				...
				<div>
					...
					style="font-weight: bold;">#{DATA.order_code}</span> đã bị hủy. 
                    <!-- BEGIN: payment -->
                    Thủ tục hoàn tiền sẽ được tiến hành từ 7 - 14 ngày.
                    <!-- END: payment -->
                    </span>
				</p>
            ...
            <div style="border-top:1px solid #DADADA; margin-top: 20px;">
                ...
                <p><span>Lý do hủy: {info_order.lydohuy}</span></p>
			</div>
		...
		<div style="display: flex;padding: 20px 10px;">
	            <div style="display: flex;width: 70%;">
	                <img src="https://{LOGO_SRC}" alt="" style="width: 22%;object-fit: contain;">
	                <div style="padding-left: 8px;">
	                    <p style="margin: 0;font-size: 10px;font-weight: 500;line-height: 16px">Công ty Cổ phần thương mại
	                        điện tử CHỢ NHÀ GIÀU</p>
	                    <span style="font-size: 10px;line-height: 16px;color: #444444;">Tầng 5, 99A Cộng Hòa, Phường 4,
	                        Quận
	                        Tân Bình,<br> Thành phố Hồ Chí Minh. </span>
	                    <p style="font-size: 10px;margin: 4px 0;">Email:
	                        <a href="mailto:{GCONFIG.site_email}"
	                            style="color:#666666;text-decoration:none">{GCONFIG.site_email}</a>
	                    </p>
	                    <p style="font-size: 10px;margin: 0;">Điện thoại:
	                        <a href="tel:{GCONFIG.site_phone}"
	                            style="color:#666666;text-decoration:none">{GCONFIG.site_phone}</a>
	                    </p>
	                </div>
	            </div>
