    ...
    <div style="width: 600px; padding: 16px; margin: 0 auto;">
        ...
        border-radius: 4px;padding: 24px 16px;">
            ...
            <div>
                ...
                <p style="margin: 0;">Đơn hàng #{DATA.order_code} đã bị hủy </p>
            ...
            <div style="display: flex;width: 70%;">
                ...
                <div style="padding-left: 8px;">
                    ...
                    <p style="font-size: 10px;margin: 4px 0;">Email:
                        <a href="mailto:{GCONFIG.email_ecng}"
                            style="color:#666666;text-decoration:none">{GCONFIG.email_ecng}</a>
                    </p>
                    <p style="font-size: 10px;margin: 0;">Điện thoại:
                        <a href="tel:{GCONFIG.phone_ecng}"
                            style="color:#666666;text-decoration:none">{GCONFIG.phone_ecng}</a>
                    </p>
                </div>
            </div>
