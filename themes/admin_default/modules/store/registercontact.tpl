...
<div class="panel panel-default">
    ...
    <h3 class="panel-title" style="float:left"><i class="fa fa-list"></i> {LANG.registercontact}</h3> 
			...
			<div class="col-xs-24 col-sm-12  col-md-12  col-lg-8">
                <div class="form-group">
                    <input class="form-control" type="text" value="{Q}" name="q" maxlength="255"
                        placeholder="Tên công ty, địa chỉ, mã số thuế, email, số điện thoại, người đại diện" />
                </div>
            </div>
