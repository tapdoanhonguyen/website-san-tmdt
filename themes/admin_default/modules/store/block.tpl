...
<div class="panel panel-default">
    ...
    <h3 class="panel-title" style="float:left"><i class="fa fa-list"></i> {LANG.block}</h3> 
    <div class="pull-right">
     <button title="Ẩn /Hiện tìm kiếm"id="tms_sea_id" data-toggle="tooltip" data-placement="top"class="btn btn-success btn-sm"><i class="fa fa-search" aria-hidden="true"></i></button> 
	  <a href="{block_add}" data-toggle="tooltip" data-placement="top" title="{LANG.block_add}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
   </div>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{VIEW.link_product_block}">{VIEW.title} ({VIEW.count} sản phẩm)</a></td>
                    <td> {VIEW.time_add} </td>
                    <td> {VIEW.user_add} </td>
