        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-center">{LANG.logo}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <img src="{VIEW.logo}" title="logo" alt="logo" style="height: 70px;">
...
<div class="panel panel-default">
    <div class="panel-body">
        <form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
            ...
            <div class="form-group">
                <label class="col-sm-5 col-md-4 control-label"><strong>Tên thương hiệu</strong> <span class="red">(*)</span></label>
...
function nv_get_alias(id) {
    ...
    if (title != '') {
        $.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=brand&nocache=' + new Date().getTime(), 'get_alias_title=' + encodeURIComponent(title), function(res) {
